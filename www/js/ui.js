...
export function renderBottomNav() {
  ...
  sidebar.innerHTML = `
    ...
    <div style="margin-top:auto;">
      <button class="nav-item" onclick="toggleThemeBtn()" style="width:100%;">
...
function updateThemeBtn() {
  ...
  if (label) label.textContent = isDark ? 'מצב בהיר' : 'מצב כהה';
}
...
export function initPage() {
  ...
  renderBottomNav();
  initOfflineBanner();
  // בדיקת עדכון כל 10 דקות
  checkAndShowUpdate(APP_VERSION);
  setInterval(() => checkAndShowUpdate(APP_VERSION), 10 * 60 * 1000);
}
